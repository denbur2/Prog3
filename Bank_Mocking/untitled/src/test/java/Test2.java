...
public class Test2 {
    ...
    public void testGetAlleKonten() {
        ...
        long kontoNr2 = bank.girokontoErstellen(kunde);
        long kontoNr3 = bank.sparbuchErstellen(kunde);

        //System.out.println("KontoNr1: " + kontoNr1);

        bank.geldEinzahlen(kontoNr1, new Geldbetrag(100.00));
        bank.geldEinzahlen(kontoNr2, new Geldbetrag(50.00));

        bank.geldUeberweisen(kontoNr1, kontoNr2, new Geldbetrag(20.00), "test");
